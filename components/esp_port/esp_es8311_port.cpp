...
#define I2S_ENABLE_PIN  GPIO_NUM_1

#define I2S_MCK_PIN     4  // MCLK 引脚
#define I2S_BCK_PIN     5  // BCLK 引脚
#define I2S_LRCK_PIN    7 // LRCLK 引脚
#define I2S_DOUT_PIN    6 // 数据输出（录制）
#define I2S_DIN_PIN     8  // 数据输入（播放）
...
{
    gpio_config_t i2s_enable_gpio_config = {
        .pin_bit_mask = 1ULL << I2S_ENABLE_PIN,
        .mode = GPIO_MODE_OUTPUT,
        .pull_up_en = GPIO_PULLUP_ENABLE,
        .pull_down_en = GPIO_PULLDOWN_DISABLE,
        .intr_type = GPIO_INTR_DISABLE,
    };
    ESP_ERROR_CHECK(gpio_config(&i2s_enable_gpio_config));
    ESP_ERROR_CHECK(gpio_set_level(I2S_ENABLE_PIN, 1));
